...
export default function NavBar({ page }) {
  ...
  return (
    ...
    className="w-full flex justify-between items-center pt-8 pb-2 px-4 lg:px-12">
     ...
     <Image src="/loading.png" width={80} height={80} alt="/" unoptimized priority className="mobilesmall:block hidden cursor-pointer" onClick={() => router.push('/')}/>
     <div className="bg-white rounded-2xl py-[3px] px-4 flex justify-between items-center gap-5">
       ...
       <div className="leading-1">
         <h5 className="text-[#4C81FF] text-[16px] font-extrabold mb-0 leading-5">Burned</h5>
         <h5 className="text-[#FFA400] text-[20px] font-extrabold leading-5">150.3 Bonk</h5>
       </div>
     </div>
    </motion.div>
    :
